...
# One-command "production -> main local DB" sync.
# WARNING: this overwrites your main local database (default: usoap).
...
LOCAL_DB_NAME="${LOCAL_DB_NAME:-usoap}"

echo "WARNING: This will overwrite local database '$LOCAL_DB_NAME'."
